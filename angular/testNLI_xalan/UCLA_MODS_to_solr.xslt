...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:mods="http://www.loc.gov/mods/v3"  xmlns:java="http://xml.apache.org/xalan/java" exclude-result-prefixes="mods java xlink">
  ...
  <xsl:template match="/">
	...
	<add>
		...
		<xsl:value-of select="mods:recordInfo/mods:recordIdentifier/text()"/>
		</xsl:if>
		</field>
