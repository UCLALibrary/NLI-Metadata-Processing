...
<xsl:stylesheet xmlns:mods="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xlink marc" version="1.0">
    ...
    <!--
        ...
        MARC21slim2MODS3-5 (Revision 1.107) 20160107
        ...
        Revision 1.104 - Fixed 111$n and 711$n to reflect mapping to <mods:namePart> tmee 20141112
        ...
        Revision 1.87 - Fixed expressions of <mods:accessCondition> type values - tmee 2013/08/29
        Revision 1.86 - Fixed 008 <mods:frequency> subfield to occur w/i <mods:originiInfo> - tmee 2013/08/29
        ...
        Revision 1.78 - Fixed 852 mapping <mods:shelfLocation> was changed to <mods:shelfLocator> - 2012/05/07 tmee
        ...
        Revision 1.46 - Aquifer revision 1.25 - Changed mapping of 767 so that <mods:type="otherVersion>  2009/11/20  tmee
        Revision 1.45 - Aquifer revision 1.24 - Changed mapping of 765 so that <mods:type="otherVersion>  2009/11/20  tmee 
        ...
        Revision 1.32 - Mapped specific note types from the MODS Note Type list <mods:http://www.loc.gov/standards/mods/mods-notes.html> tmee 2009/11/17
    ...
    <xsl:template match="/">
        <xsl:choose>
            <xsl:when test="//marc:collection">
                <mods:modsCollection  xmlns:mods="http://www.loc.gov/mods/v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-5.xsd">
            ...
            <xsl:otherwise>
                <mods:mods xmlns:mods="http://www.loc.gov/mods/v3"
                    ...
                    <mods:relatedItem type="host">
                        <mods:titleInfo>
                            <mods:title> Time Travel Collection of Ephemera from the National
                                Library of Israel </mods:title>
                        </mods:titleInfo>
                    </mods:relatedItem>
                    <mods:name type="corporate" authority="naf">
                        <mods:namePart> University of California, Los Angeles. $b Library. </mods:namePart>
                        <mods:role>
                            <mods:roleTerm type="text"> repository </mods:roleTerm>
                            <mods:roleTerm type="code"> rps </mods:roleTerm>
                        </mods:role>
                    </mods:name>
                    <mods:name type="corporate" authority="naf"
                        authorityURI="https://lccn.loc.gov/no2009197324">
                        <mods:namePart lang="heb">Sifriyah ha-le'umit (Israel)</mods:namePart>
                        <mods:namePart>National Library of Israel</mods:namePart>
                        <mods:role>
                            <mods:roleTerm type="text">repository</mods:roleTerm>
                            <mods:roleTerm type="code">rps</mods:roleTerm>
                        </mods:role>
                    </mods:name>
                    <mods:name type="corporate" script="Hebr">
                        <mods:namePart>ספרייה הלאומית של ישראל</mods:namePart>
                        <mods:role>
                            <mods:roleTerm type="text">repository</mods:roleTerm>
                            <mods:roleTerm type="code">rps</mods:roleTerm>
                        </mods:role>
    ...
    <xsl:template name="marcRecord">
		...
		<xsl:for-each select="marc:datafield[@tag='911']">
			<mods:location>
        ...
        <xsl:if test="$typeOf008='BK'">
            ...
            <xsl:choose>
                <xsl:when test="contains($controlField008-28,'a')">
                    <mods:genre authority="marcgt">government publication</mods:genre>
                </xsl:when>
        ...
        <mods:originInfo>
            ...
            <xsl:if test="($controlField008-6='e' or $controlField008-6='p' or $controlField008-6='r' or $controlField008-6='s' or $controlField008-6='t') and ($leader6='d' or $leader6='f' or $leader6='p' or $leader6='t')">
                <xsl:if test="$controlField008-7-10 and ($controlField008-7-10 != $dataField260c)">
                  <mods:dateCreated encoding="marc">
        ...
        <mods:recordInfo>
            ...
            <mods:recordOrigin>
                Converted from MARCXML to MODS version 3.5 using MARC21slim2MODS3-5.xsl (Revision 1.107 2016/1/7)
            </mods:recordOrigin>
